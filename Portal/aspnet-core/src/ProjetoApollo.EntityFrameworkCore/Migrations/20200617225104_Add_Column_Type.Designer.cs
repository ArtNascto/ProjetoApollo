...
namespace ProjetoApollo.Migrations
{
    ...
    [Migration("20200617225104_Add_Column_Type")]
    partial class Add_Column_Type
    {
        protected override void BuildTargetModel(ModelBuilder modelBuilder)
        {
#pragma warning disable 612, 618
            modelBuilder
                .HasDefaultSchema("Apollo")
            ...
            modelBuilder.Entity("ProjetoApollo.Apollo.Core.Client", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("ProjetoApollo.Apollo.Core.Doctors", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.ToTable("Doctors","Apollo");
                });

            modelBuilder.Entity("ProjetoApollo.Apollo.Core.Historic", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("ProjetoApollo.Apollo.Core.Institution", b =>
                {
                    ...
                    b.ToTable("Institution","Apollo");
                });

            modelBuilder.Entity("ProjetoApollo.Apollo.Core.MedicalConsultation", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("ProjetoApollo.Apollo.Core.Speciality", b =>
                {
                    ...
                    b.ToTable("Speciality","Apollo");
                });

            modelBuilder.Entity("ProjetoApollo.Authorization.Roles.Role", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("ProjetoApollo.Authorization.Users.User", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("ProjetoApollo.MultiTenancy.Tenant", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("Abp.Authorization.Roles.RoleClaim", b =>
                {
                    b.HasOne("ProjetoApollo.Authorization.Roles.Role", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Abp.Authorization.Users.UserClaim", b =>
                {
                    b.HasOne("ProjetoApollo.Authorization.Users.User", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("ProjetoApollo.Apollo.Core.Address", b =>
                {
                    b.HasOne("ProjetoApollo.Apollo.Core.Client", "Client")
                        .WithOne("Address")
                        .HasForeignKey("ProjetoApollo.Apollo.Core.Address", "ClientId");
            ...
            modelBuilder.Entity("ProjetoApollo.Apollo.Core.Doctors", b =>
                {
                    ...
                    b.HasOne("ProjetoApollo.Apollo.Core.Speciality", "Speciality")
                        .WithMany()
            ...
            modelBuilder.Entity("ProjetoApollo.Apollo.Core.Historic", b =>
                {
                    ...
                    b.HasOne("ProjetoApollo.Apollo.Core.Doctors", "Doctors")
                        .WithMany()
            ...
            modelBuilder.Entity("ProjetoApollo.Authorization.Roles.Role", b =>
                {
                    b.HasOne("ProjetoApollo.Authorization.Users.User", "CreatorUser")
                        .WithMany()
                        .HasForeignKey("CreatorUserId");

                    b.HasOne("ProjetoApollo.Authorization.Users.User", "DeleterUser")
                        .WithMany()
                        .HasForeignKey("DeleterUserId");

                    b.HasOne("ProjetoApollo.Authorization.Users.User", "LastModifierUser")
                        .WithMany()
