...
{
    public abstract class ProjetoApolloWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static ProjetoApolloWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(ProjetoApolloWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<ProjetoApolloDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<ProjetoApolloDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<ProjetoApolloDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<ProjetoApolloDbContext, Task<T>> func)
        {
            T result;
