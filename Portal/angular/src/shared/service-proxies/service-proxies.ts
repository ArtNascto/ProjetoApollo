...
@Injectable()
export class ApolloServiceProxy {
    private http: HttpClient;
    private baseUrl: string;
    protected jsonParseReviver: ((key: string, value: any) => any) | undefined = undefined;
     ...
     * @return Success
     */
    getMedicalInsurances(): Observable<string[]> {
        let url_ = this.baseUrl + "/api/services/app/Apollo/GetMedicalInsurances";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processGetMedicalInsurances(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processGetMedicalInsurances(<any>response_);
                } catch (e) {
    ...
    protected processGetMedicalInsurances(response: HttpResponseBase): Observable<string[]> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
     ...
     * @return Success
     */
    registerInstitution(body: CreateInstitutionInput | undefined): Observable<CreateInstitutionOutput> {
        let url_ = this.baseUrl + "/api/services/app/Apollo/RegisterInstitution";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processRegisterInstitution(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processRegisterInstitution(<any>response_);
                } catch (e) {
                    return <Observable<CreateInstitutionOutput>><any>_observableThrow(e);
                }
            } else
                return <Observable<CreateInstitutionOutput>><any>_observableThrow(response_);
        }));
    }

    protected processRegisterInstitution(response: HttpResponseBase): Observable<CreateInstitutionOutput> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = CreateInstitutionOutput.fromJS(resultData200);
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
        ...
        return _observableOf<CreateInstitutionOutput>(<any>null);
    }

    /**
     * @return Success
     */
    createInstitution(): Observable<InstitutionDto> {
        let url_ = this.baseUrl + "/api/services/app/Apollo/CreateInstitution";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return <Observable<InstitutionDto>><any>_observableThrow(e);
                }
            } else
                return <Observable<InstitutionDto>><any>_observableThrow(response_);
        }));
    }

    protected processCreateInstitution(response: HttpResponseBase): Observable<InstitutionDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
     ...
     * @return Success
     */
    getQuestionary(): Observable<QuestionaryDto> {
        let url_ = this.baseUrl + "/api/services/app/Apollo/GetQuestionary";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processGetQuestionary(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processGetQuestionary(<any>response_);
                } catch (e) {
                    return <Observable<QuestionaryDto>><any>_observableThrow(e);
                }
            } else
                return <Observable<QuestionaryDto>><any>_observableThrow(response_);
        }));
    }

    protected processGetQuestionary(response: HttpResponseBase): Observable<QuestionaryDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = QuestionaryDto.fromJS(resultData200);
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
        ...
        return _observableOf<QuestionaryDto>(<any>null);
    }
    ...
    getClient(): Observable<ClientDto> {
        let url_ = this.baseUrl + "/api/services/app/Apollo/GetClient";
        url_ = url_.replace(/[?&]$/, "");
...
export class RegisterInput implements IRegisterInput {
    ...
    medicalInsurance: string | undefined;
    ...
    init(_data?: any) {
        if (_data) {
            ...
            this.medicalInsurance = _data["medicalInsurance"];
        }
    }
...
export class BillingDto implements IBillingDto {
    ...
    init(_data?: any) {
        if (_data) {
            ...
            this.expiresDate = _data["expiresDate"];
        }
    }
...
export class CreateInstitutionInput implements ICreateInstitutionInput {
    institution: InstitutionDto;

    constructor(data?: ICreateInstitutionInput) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    init(_data?: any) {
        if (_data) {
            this.institution = _data["institution"] ? InstitutionDto.fromJS(_data["institution"]) : <any>undefined;
        }
    }

    static fromJS(data: any): CreateInstitutionInput {
        data = typeof data === 'object' ? data : {};
        let result = new CreateInstitutionInput();
        result.init(data);
        return result;
    }
...
export class CreateInstitutionOutput implements ICreateInstitutionOutput {

    constructor(data?: ICreateInstitutionOutput) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): CreateInstitutionOutput {
        data = typeof data === 'object' ? data : {};
        let result = new CreateInstitutionOutput();
        result.init(data);
        return result;
    }
...
export interface ICreateInstitutionOutput {
}

export class QuestionaryDto implements IQuestionaryDto {
    id: number;
    ...
    constructor(data?: IQuestionaryDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    init(_data?: any) {
        if (_data) {
            ...
            this.nextQuestion = _data["nextQuestion"];
        }
    }

    static fromJS(data: any): QuestionaryDto {
        data = typeof data === 'object' ? data : {};
        let result = new QuestionaryDto();
        result.init(data);
        return result;
    }
    ...
    toJSON(data?: any) {
        ...
        data["nextQuestion"] = this.nextQuestion;
        return data; 
    }

    clone(): QuestionaryDto {
        const json = this.toJSON();
        let result = new QuestionaryDto();
        result.init(json);
        return result;
...
export interface IQuestionaryDto {
    id: number;
    label: string | undefined;
    description: string | undefined;
    priority: string | undefined;
